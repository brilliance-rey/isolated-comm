...
import com.sunkaisens.isolated.common.utils.AddressUtil;
import com.sunkaisens.isolated.common.utils.SortUtil;
import com.sunkaisens.isolated.system.dao.LogMapper;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, SysLog> implements LogService {
    ...
    public IPage<SysLog> findLogs(QueryRequest request, SysLog sysLog) {
        try {
            ...
            SortUtil.handlePageSort(request, page, "createTime", SysConstant.ORDER_DESC, true);
