package com.sunkaisens.isolated.common.handler;
...
import com.sunkaisens.isolated.common.exception.LimitAccessException;
...
public class GlobalExceptionHandler {
    ...
    public SunkResponse validExceptionHandler(BindException e) {
        ...
        return new SunkResponse().message(message.toString());
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public SunkResponse handleConstraintViolationException(ConstraintViolationException e) {
        StringBuilder message = new StringBuilder();
    ...
    public SunkResponse handleLimitAccessException(LimitAccessException e) {
