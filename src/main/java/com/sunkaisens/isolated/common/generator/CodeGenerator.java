package com.sunkaisens.isolated.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/isolated_comm?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "root";
    // 数据库密码
    private static final String PASSWORD = "sunkaisens";
    // @author 值
    private static final String AUTHOR = "Reneryan";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.sunkaisens.isolated";
    // xml文件路径
